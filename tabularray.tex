...
you can use \CC{\DefTblrTemplate}\footnote{From version 2022A,
\CC{\DefTblrTemplate} has another name \CC{\DeclareTblrTemplate}.}
...
In the above code, command \CC{\DefTblrTemplate} defines the templates with name \TN{normal},
...
If you use \TN{default} as template name in \CC{\DefTblrTemplate},
...
Note that you can define the same template for multiple elements in \CC{\DefTblrTemplate} command.
