...
This library brings intuitive functional programming into \verb!tabularray! tables.

\subsection{Evaluate inner specifications}

With this library, \verb!tabularray! will evaluate every function
(defined with \verb!\prgNewFunction!) within inner specifications,
...
As a policy, \verb!tabularray! can support at most four TeX Live releases with latest updates.
For example, \verb!tabularray! releases published in \the\year{} could be used in TeX Live
