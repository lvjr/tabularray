...
and set the \verb!caption-tag! and \verb!caption-sep! templates (see below) to empty.
...
You may change the styles of template elements with \verb!\SetTblrStyle! command:
...
There is also an \verb!talltblr! environment as an alternative to \verb!threeparttable! environment.
