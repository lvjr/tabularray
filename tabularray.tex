...
\colorlet{highback}{\ifcase\month\or
  red9\or olive9\or azure9\or red9\or olive9\or azure9\or
  red9\or olive9\or azure9\or red9\or olive9\or azure9\fi
}
\CodeHigh{bg=highback,codebox/bg=highback}
\NewCodeHighEnv{code}{bg=gray9,codebox/bg=gray9}
\NewCodeHighEnv{demo}{bg=gray9,codebox/bg=gray9,demo}
...
%\CodeHigh{lite}
%\dochighinput[long]{tabularray.sty}
